...
<head>
  ...
  <script type="text/javascript">
    ...
    function check() {
      ...
      else if (check_times == "" || check_times <= 0) {
  ...
  <div class="contener">
    <div class="left">
      ...
      <form name="form2" method="POST" action="home_submit.php" onsubmit="return check()">
        ...
        回数&emsp;&emsp;：
        <input type="text" pattern="[0-9]+" maxlength="4" name="times" value="1"><br>

        グループ：
        <div id="group_selector" style="display: inline-block; _display: inline;"></div><br><br>

        メモ（「,」「/」使用不可）<br>
        <input type="text" style="width:500px;" pattern="[^,/]+" name="memo" placeholder="メモ"></textarea><br><br>
